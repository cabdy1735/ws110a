  ...
  <head>
    ...
    <div class=top>
          <div style=float:left>
              <button class="btn"><a onclick="Shop.start()">留言網</a></button>
          </div>
          <div class=right>
          <button class="btn"><a onclick="Order.start()">留言紀錄</a></button>
          <div class=drop>
              <button class="btn"><a onclick="Setting.start()">帳號</a></button>
              <div class=down>
                  <a href="/login">Login</a>'Welcome '+<a href="/logout">Logout</a>
                  <a href="/login">登入</a>
                  <a href="#logout">登出</a>
                  <a href="#signup">註冊</a>
